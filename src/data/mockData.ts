...
export const mockCustomers: Customer[] = [
  ...
  },
  {
    ...
    specialRequests: 'Đã gửi báo giá chi tiết, lớp đang thương lượng tỷ lệ cọc và giữ slot ekip thợ chính.',
    notes: 'Lớp đồng ý gói 11.8M, đang thương lượng cọc giữ lịch 28/11. Chờ gửi QR chuyển khoản.',
    source: 'TikTok',
...
export const mockBookings: Booking[] = [
  {
    ...
    assignments: {
      leadPhotographerId: 'p-1',
      leadPhotographerName: 'Alex Đức Anh (Xoắn Lead)',
      assistantPhotographerIds: ['p-3'],
      assistantNames: ['Trần Minh Tuấn']
    },
  ...
  },
  {
    ...
    bookingStatus: 'Đã xác nhận',
    assignments: {
      leadPhotographerId: 'p-2',
      leadPhotographerName: 'Duy Kool (Xoắn Creative)',
      assistantPhotographerIds: ['p-4'],
      assistantNames: ['Vũ Thành Đạt (Quay Flycam)']
    },
