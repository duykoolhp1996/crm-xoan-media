...
export const mockCustomers: Customer[] = [
  ...
  },
  {
    ...
    specialRequests: 'Đã gửi báo giá chi tiết, lớp đang họp xin ý kiến phụ huynh và chốt ngày cọc.',
    notes: 'Đã gửi bảng báo giá PDF và tin nhắn Zalo cho Bí thư. Chờ phản hồi vào thứ 2 tới.',
    source: 'TikTok',
