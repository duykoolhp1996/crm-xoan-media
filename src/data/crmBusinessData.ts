...
export const CRM_CTV_SALES: CtvSaleMember[] = [
  {
    ...
    classesClosed: 32,
    conversionRate: '47.0%',
    revenueGenerated: '584.000.000đ',
    revenueValue: 584000000,
    commissionEarned: '46.720.000đ',
    commissionRate: '8%',
    payoutStatus: 'Đã quyết toán',
    ranking: 1
  },
  {
    id: 'ctv-2',
    ...
    classesClosed: 26,
    conversionRate: '48.1%',
    revenueGenerated: '438.000.000đ',
    revenueValue: 438000000,
    commissionEarned: '35.040.000đ',
    commissionRate: '8%',
    payoutStatus: 'Chờ đối soát',
    ranking: 2
  },
  {
    id: 'ctv-3',
    ...
    classesClosed: 22,
    conversionRate: '45.8%',
    revenueGenerated: '392.000.000đ',
    revenueValue: 392000000,
    commissionEarned: '31.360.000đ',
    commissionRate: '8%',
    payoutStatus: 'Đã quyết toán',
    ranking: 3
  },
  {
    ...
    classesClosed: 16,
    conversionRate: '42.1%',
    revenueGenerated: '264.000.000đ',
    revenueValue: 264000000,
    commissionEarned: '21.120.000đ',
    commissionRate: '8%',
  ...
  },
  {
    ...
    classesClosed: 12,
    conversionRate: '37.5%',
    revenueGenerated: '186.000.000đ',
    revenueValue: 186000000,
    commissionEarned: '14.880.000đ',
    commissionRate: '8%',
    payoutStatus: 'Chờ đối soát',
    ranking: 5
  }
