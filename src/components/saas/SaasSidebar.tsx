        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="w-10 h-10 rounded-2xl flex items-center justify-center text-neutral-400 hover:text-neutral-800 hover:bg-neutral-100 transition-colors relative"
